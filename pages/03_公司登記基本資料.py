...
import pandas as pd
from Home import search_company_by_business_no, convert_df

st.title("公司登記基本資料")
st.write("輸入多項條件時請以逗號 , 分隔")

form = st.form("search_company_by_business_no")
...
if (input_is_empty is False) and (submitted):
    with st.spinner("查詢中..."):
        ...
        for n in business_no:
            company = search_company_by_business_no(business_no=n)
